...
class TicketFavoriteDetail extends StatefulWidget {
  ...
  @override
  _TicketFavoriteDetailState createState() => _TicketFavoriteDetailState();
}

class _TicketFavoriteDetailState extends State<TicketFavoriteDetail> {
  @override
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        ...
        return InkWell(
          onTap: () {
            Navigator.of(context).push(PageRouteBuilder(
                pageBuilder: (_, __, ___) => new TicketFavoriteDetail(
                      title: title,
                      id: id,
                      image: image,
                      category: category,
