...
import 'package:tasty_cookpad/consumable_store.dart';
...
class _RecipeDetailScreenState extends State<RecipeDetailScreen> {
  ...
  _timer() async {
    return Timer(Duration(milliseconds: 500), _adsIntersial);
  }

  void _adsIntersial() {
    ConsumableStore.isPurchase().then((value) => {
      if (value == false) {
        myInterstitialAd
          ..load()
          ..show(
  ...
  void initState() {
    ...
    //  .initialize(appId: 'ca-app-pub-3348325660551223~2787172294');
  ...
  static const MobileAdTargetingInfo targetingInfo = MobileAdTargetingInfo(
    keywords: <String>['recipe', 'recipe apps', 'food', 'desert', 'meals'],
  ...
  BannerAd myBanner = BannerAd(
    ...
    //adUnitId: 'ca-app-pub-3348325660551223/2020885531',
  ...
  InterstitialAd myInterstitialAd = InterstitialAd(
    ...
    //adUnitId: 'ca-app-pub-3348325660551223/9189214523',
    targetingInfo: targetingInfo,
    listener: (MobileAdEvent event) {
