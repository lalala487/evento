...
class ConsumableStore {
  ...
  static Future<bool> isPurchase() async
  {
      final prefs = await SharedPreferences.getInstance();
      if (!prefs.containsKey('removeAds'))
        return false;
      // set value
      debugPrint (" ppppppppppppuuuuuuuuuuuuccccccccccccaaaaaaaaaaaaarrrrrrrrseee : ${prefs.getBool('removeAds')}");
      return prefs.getBool('removeAds');
  }
